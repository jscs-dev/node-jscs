...
describe('rules/require-var-decl-first', function() {
    describe('boolean', function() {
        ...
        describe('rule checks', function() {
            var testDeclStatements = function(statement, expectedErrorCount) {
                var results;
                var resultCount;
                var errors;
                var count;
            ...
            describe('statements without spaces or linebreaks', function() {
                ...
                it('should not return errors for multiple var declaration with a single comment before the ' +
                    ...
                    testDeclStatements('var a;/*block comment*/var b;/*block comment 2*/var c;', 0);
                });
            ...
            describe.only('te', function() {
                it('shou asdasda', function() {
                    testDeclStatements('if(0){}var b;', 1);
                });

                it('should return 2 errors for 2 var declarations not at the top of program scope', function() {
                    testDeclStatements('var a;a=1;var b;var c=1;', 2);
                });



                // it('should aaareturn 1 error for single var declaration not at top of function declaration scope',
                //     function() {
                //     testDeclStatements('var a; function b(){c=2;var d;}', 1);
                // });

                // it('should a return 1 error for single var declaration not at top of program scope', function() {
                //     testDeclStatements('var a;a=1;var b;', 1);
                // });

                // it('should return 1 error for single var declaration that ' +
                //     'occurs after a function declaration', function() {
                //     testDeclStatements('var a;function b(){var c;}var d;', 1);
                // });

                // it('should return 1 error for single var declaration not at top of function declaration scope',
                //     function() {
                //     testDeclStatements('var a;function b(){var c;c=1;var d;}', 1);
                // });
           });
            ...
            describe('statements with linebreaks', function() {
                ...
                it('should not return errors for single var declaration after single comment at top of program scope',
                    function() {
                    testDeclStatements('/*block comment*/\nvar a;', 0);
                });

                it('should not return errors for single var declaration at top of function declaration scope',
                    function() {
                    testDeclStatements('function a() {\nvar b;\n}', 0);
                });
                ...
                ' first variable declaration', function() {
                    testDeclStatements('var a = function() {  var b;\n/*block comment*/\n};\nvar c;', 0);
                });
            });
        });
    });
