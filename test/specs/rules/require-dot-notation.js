...
describe.skip('rules/require-dot-notation', function() {
    var checker;
    ...
    describe.skip('true value with es3 explicitly enabled', function() {
        beforeEach(function() {
    ...
    describe.skip('true value with es3 explicitly disabled', function() {
        beforeEach(function() {
    ...
    describe.skip('option value `except_snake_case`', function() {
        beforeEach(function() {
