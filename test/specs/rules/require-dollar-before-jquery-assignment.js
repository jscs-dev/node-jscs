...
describe.skip('rules/require-dollar-before-jquery-assignment', function() {
    var checker;
    ...
    describe.skip('option value `true`', function() {
        ...
        describe.skip('in object definition', function() {
    ...
    describe.skip('option value `"ignoreProperties"`', function() {
        beforeEach(function() {
