...
var er = new Errors({isEnabledRule:function(){return true;}, getFilename:function(){return 'input';}});
er.setCurrentRule('rule');
er.add('Hello World', {}, 0);
er.setCurrentRule('parseError');
er.add('Hello World!', {}, 0);

chai.expect(er).to.have.one.parse.error.from('parseError');
