...
describe('rules/require-newline-after-array-elements', function() {
    var checker;
    ...
    describe('{ maximum: true }', function() {
        it('should throws', function() {
            assert.throws(function() {
                checker.configure({ requireNewlineAfterArrayElements: { maximum: true } });
            });
        });
    });
    ...
    describe('true option', function() {
        beforeEach(function() {
            checker.configure({ requireNewlineAfterArrayElements: true });
        });
    ...
    describe('with value 3', function() {
        beforeEach(function() {
            checker.configure({ requireNewlineAfterArrayElements: 3 });
        });
    ...
    describe('maximum 3', function() {
        beforeEach(function() {
            checker.configure({ requireNewlineAfterArrayElements: { maximum: 3 } });
        });
    ...
    describe('maximum 2, ignoreBrackets true', function() {
        beforeEach(function() {
            checker.configure({ requireNewlineAfterArrayElements: { maximum: 2, ignoreBrackets: true } });
        });
    ...
    describe('ignoreBrackets true', function() {
        beforeEach(function() {
            checker.configure({ requireNewlineAfterArrayElements: { ignoreBrackets: true } });
        });
