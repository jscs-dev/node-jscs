...
describe('rules/disallow-space-after-ternary-operator', function() {

    var checker;
    beforeEach(function() {
        checker = new Checker();
        checker.registerDefaultRules();
        checker.configure({ disallowSpaceAfterTernaryOperator: true });
    });
    it('should report about space after tokens "?" and ":" ("a ? b : c;")', function() {
