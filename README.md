...
`jscs` is a code style checker. You can configure `jscs` for you project in detail using **over 60** validation rules. [jQuery](https://github.com/mdevils/node-jscs/blob/master/lib/presets/jquery.json) and [Google](https://github.com/mdevils/node-jscs/blob/master/lib/presets/google.json) presets are also available.
