...
/**
 * Return true if node is guard clause.
 *
 * @param {Object} node
 * @returns {Boolean}
 */
var GUARD_STATEMENTS = ['ReturnStatement', 'BreakStatement', 'ContinueStatement'];
exports.isGuardClause = function(node) {
    ...
    if (GUARD_STATEMENTS.indexOf(node.consequent.type) !== -1 ||
        (node.consequent.type === 'BlockStatement' &&
         GUARD_STATEMENTS.indexOf(node.consequent.body[0].type) !== -1)
    ) {
        return true;
    }
    return false;
