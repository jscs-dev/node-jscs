...
var incrementAndDecrementOperators = ['++', '--'];
 ...
 * @type {Array}
 */
exports.unaryOperators = ['-', '+', '!', '~'].concat(incrementAndDecrementOperators);

/**
 * Increment and decrement operators
 * @type {Array}
 */
exports.incrementAndDecrementOperators = incrementAndDecrementOperators;
