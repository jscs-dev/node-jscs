 ...
 *
 * If `requireMultipleVariableDeclarations` defined as a `true` value, it will
 * report only consecutive vars, if, on the other hand, value equals to
 * `"onevar"` string, `requireMultipleVariableDeclarations` will allow only one
 * `var` per function scope.
 *
 * If the value is `allExcept: ['require']`, then require statements are allowed
 * to have a var declaration per variable.
 *
 ...
 *
 * ```js
 * "requireMultipleVariableDeclarations": true
 * ```
 *
 * ##### Valid
 *
...
module.exports.prototype = {
    ...
    getOptionName: function() {
        return 'requireMultipleVariableDeclarations';
    },
