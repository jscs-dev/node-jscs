...
module.exports.prototype = {
    ...
    check: function(file, errors) {
        ...
        function getIndentationFromLine(line) {
            ...
            var numTabs;
            if (indentChar === ' ') {
                // recompute firstContent assuming tabs are spaces.
                numTabs = line.substring(0, firstContent).split('\t').length - 1;
                firstContent = firstContent - numTabs + numTabs * indentSize;
            }
            if (firstContent === -1) {
        ...
        var realRegexSrc = indentChar === ' ' ? indentChar + '\t' : indentChar;
        var rNotIndentChar = new RegExp('[^' + realRegexSrc + ']');
