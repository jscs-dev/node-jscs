 ...
 * "validateIndentation": "\t",
 * @example <caption>Valid example for mode `2`:</caption>
 * if (a) {
 *   b=c;
 *   function(d) {
 *     e=f;
 *   }
 * }
 * @example <caption>Invalid example for mode `2`:</caption>
 * if (a) {
 *    b=c;
 * function(d) {
 *        e=f;
 * }
 * }
 * @example <caption>Valid example for mode "\t":</caption>
 * if (a) {
 *     b=c;
 *     function(d) {
 *         e=f;
 *     }
 * }
 * @example <caption>Invalid example for mode "\t":</caption>
 * if (a) {
 *      b=c;
 * function(d) {
 *            e=f;
