...
module.exports.prototype = {
    configure: function(options) {
        assert(
            options === 'onevar' || options === 'nonconsecutive' || options === 'onedecl',
            this.getOptionName() + ' option requires a string value `onevar` `nonconsecutive` or `onedecl`'
        );

        this._check = options === 'onevar' ? onevar : (options === 'nonconsecutive' ? nonconsecutive : onedecl);
    },
