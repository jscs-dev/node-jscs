 ...
 * ```
 * @example <caption>Valid example for mode `{ "mark": "\"", "escape": true }`:</caption>
 * var x = "x";
 * var y = '"x"';
 * @example <caption>Invalid example for mode `{ "mark": "\"", "escape": true }`:</caption>
 * var x = "x";
 * var y = 'x';
 * @example <caption>Valid example for mode `"\""` or mode `true`:</caption>
 * var x = "x";
 * @example <caption>Valid example for mode `"'"` or mode `true`:</caption>
 * var x = 'x';
