...
function getUnusedNodes(node, variableMap, groupIfPossible) {
    if (node.type === 'Identifier') {
        ...
        var hasUsages = variable.references.some(function(reference) {
            return !variable.definitions.some(function(definition) {
...
module.exports.prototype = {
    ...
    check: function(file, errors) {
        ...
        file.iterateNodesByType(
            ...
            function(node) {
                var variableMap = file.getScopes().acquire(node).variables
    ...
    _fix: function(file, error) {
        ...
        if (parentElement.type === 'Property') {
