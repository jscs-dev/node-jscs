 ...
 * Values: `true`
 *
 * if `requireVariableDeclarationsFirst` defined as a `true` value, it will report errors of `var` declarations that
 * does not appear on the top of a function scope.
 *
 * #### Example
 *
 * ```js
 * "requireVariableDeclarationsFirst": true
 * ```
 *
 * ##### Valid
 *
...
module.exports.prototype = {
    ...
    getOptionName: function() {
        return 'requireVariableDeclarationsFirst';
    },
