...
var getCommentErrors = function(comment, keywordRegEx) {
    ...
    splitComment.forEach(function(commentNode, index) {
        ...
        errors = errors.concat(matches.map(function(match) {
            ...
            foundAtIndex = commentNode.indexOf(match, lastIndex);
            lastIndex = foundAtIndex;
            ...
            return {
                ...
                column: lineIndex <= 0 ? foundAtIndex += 2 : foundAtIndex
            };
        }));
    });
...
module.exports.prototype = {
    ...
    check: function(file, errors) {
        file.getComments().forEach(function(comment) {
            if (comment.value.search(this._keywordRegEx) === -1) { return; }
