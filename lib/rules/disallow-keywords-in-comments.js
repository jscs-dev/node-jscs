...
module.exports.prototype = {
    ...
    check: function(file, errors) {
        file.iterateTokensByType(['LineComment', 'BlockComment'], function(comment) {
            var match;
            var commentOffset = 2; // Both '//' and '/*' comment starters have offset '2'.
            this._keywordRegEx.lastIndex = 0;
            while ((match = this._keywordRegEx.exec(comment.value)) !== null) {
                errors.add(
                    this._message,
                    comment,
