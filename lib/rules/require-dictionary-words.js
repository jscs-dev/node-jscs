...
module.exports.prototype = {
    ...
    configure: function(options) {
        ...
        var excluded;
        if (wasObject) {
            specifiedWordDictionaries = options.dictionaries;
            if (specifiedWordDictionaries !== undefined) {
                assert(
                    Array.isArray(specifiedWordDictionaries),
                    this.getOptionName() + '.dictionaries option requires ' +
                        'an array value or should be removed'
                );
                wordDictionaries = specifiedWordDictionaries;
            }
