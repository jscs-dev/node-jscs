...
var requirePeer = codependency.get('jscs');
...
module.exports.prototype = {
    ...
    configure: function(options) {
        ...
        this._wordDictionaries = wordDictionaries.map(function(language) {
            ...
            if (wordlistMap.hasOwnProperty(language)) {
                return requirePeer(wordlistMap[language])[language];
            }
            // General case where a package is one-to-one with a wordlist.
            return requirePeer('wordlist-' + language)[language];
        });
