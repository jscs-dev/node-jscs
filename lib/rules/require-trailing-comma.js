...
module.exports.prototype = {
    ...
    check: function(file, errors) {
        ...
        file.iterateNodesByType([
            ...
            var possibleComma = file.getLastNodeToken(node).previousCodeToken;
    ...
    _fix: function(file, error) {
        ...
        if (parent.type.indexOf('Array') === 0) {
            afterProp = parent.elements[parent.elements.length - 1].lastChild.nextToken;

        // ObjectExpression/ObjectPattern
        } else {
            afterProp = parent.properties[parent.properties.length - 1].lastChild.nextToken;
        };
