...
module.exports.prototype = {
    ...
    configure: function(disallowSpacesInsideCurlyBraces) {
        assert(
            disallowSpacesInsideCurlyBraces === true || disallowSpacesInsideCurlyBraces === 'all' ||
            disallowSpacesInsideCurlyBraces === 'nested',
            'disallowSpacesInsideCurlyBraces option requires "all"(true value) or "nested" string'
        );

        this._mode = disallowSpacesInsideCurlyBraces === true ? 'all' : disallowSpacesInsideCurlyBraces;
    },

    getOptionName: function() {
        return 'disallowSpacesInsideCurlyBraces';
    },
