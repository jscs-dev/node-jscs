 ...
 *
 * ```js
 * "requireNewlineAfterArrayElement": {
 *   "maximum": 3
 * }
 * ```
 *
...
module.exports.prototype = {
    configure: function(requireNewlineAfterArrayElements) {
        assert(
            requireNewlineAfterArrayElements === true ||
            typeof requireNewlineAfterArrayElements === 'number' && requireNewlineAfterArrayElements >= 1 ||
            typeof requireNewlineAfterArrayElements === 'object',
            'requireNewlineAfterArrayElements option requires maximal number of items ' +
                'or true value either should be removed'
        );
        if (typeof requireNewlineAfterArrayElements === 'object') {
            var opts = this._options = requireNewlineAfterArrayElements;
            ...
            this._options = {
                maximum: requireNewlineAfterArrayElements === true ? Infinity : requireNewlineAfterArrayElements,
    ...
    getOptionName: function() {
        return 'requireNewlineAfterArrayElements';
    },
