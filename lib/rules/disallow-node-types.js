...
module.exports.prototype = {
    configure: function(disallowedNodeTypes) {
        assert(
            Array.isArray(disallowedNodeTypes),
            'disallowIdentifierNames option requires an array'
        );

        this._disallowedNodeTypes = disallowedNodeTypes;
    },
    ...
    check: function(file, errors) {
        file.iterateNodesByType(this._disallowedNodeTypes, function(node) {
