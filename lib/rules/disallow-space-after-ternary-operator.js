...
module.exports.prototype = {
    ...
    getOptionName: function() {
        return 'disallowSpaceAfterTernaryOperator';
    },
    ...
    check: function(file, errors) {
        ...
        file.iterateNodesByType(['ConditionalExpression'], function(node) {
            ...
            if (source.charAt(qMarkIndex + 1) === ' ') {
                errors.add('Token "?" should stick to following expression', getTokenLoc(qMarkIndex));
            }
            if (source.charAt(colonIndex + 1) === ' ') {
                errors.add('Token ":" should stick to following expression', getTokenLoc(colonIndex));
            }
        });
    }
};
