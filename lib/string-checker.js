...
StringChecker.prototype = {
    ...
    registerDefaultRules: function() {
        ...
        this.registerRule(new (require('./rules/disallow-padding-newlines-before-keywords'))());
        ...
        this.registerRule(new (require('./rules/require-spaces-around-function-arguments'))());
