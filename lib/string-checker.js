...
StringChecker.prototype = {
    ...
    checkString: function(source, filename) {
        ...
        if (!file._program || !file._program.firstChild) {
            return errors;
        }
    ...
    _checkJsFile: function(file, errors) {
        ...
        this._configuredRules.forEach(function(rule) {
            ...
            try {
                ...
                errors.add(getInternalErrorMessage(rule.getOptionName(), e.stack), file.getProgram(), 0);
            }
        }, this);
    ...
    _addParseError: function(errors, parseError) {
        ...
        errors.add(parseError.message, null, parseError.pos);
