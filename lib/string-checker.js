...
StringChecker.prototype = {
    ...
    registerDefaultRules: function() {
        ...
        this.registerRule(new (require('./rules/disallow-space-before-ternary-operator'))());
        this.registerRule(new (require('./rules/require-space-before-ternary-operator'))());

        this.registerRule(new (require('./rules/disallow-space-after-ternary-operator'))());
        this.registerRule(new (require('./rules/require-space-after-ternary-operator'))());
