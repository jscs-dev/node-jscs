...
JsFile.prototype = {
    ...
    getCommentAfterToken: function(token) {
        var nextToken = this.getNextToken(token, {includeComments: true});
        return nextToken && nextToken.isComment ? nextToken : undefined;
    },
    ...
    getCommentBeforeToken: function(token) {
        var prevToken = this.getPrevToken(token, {includeComments: true});
        return prevToken && prevToken.isComment ? prevToken : undefined;
    },
