...
Configuration.prototype.registerDefaultRules = function() {
    ...
    */
    ...
    this.registerRule(require('../rules/require-multiple-var-decl')); // TODO: Remove in 3.0
    this.registerRule(require('../rules/disallow-multiple-var-decl')); // TODO: Remove in 3.0
    this.registerRule(require('../rules/require-multiple-variable-declarations'));
    this.registerRule(require('../rules/disallow-multiple-variable-declarations'));
    this.registerRule(require('../rules/require-variable-declarations-first'));
