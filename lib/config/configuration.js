...
Configuration.prototype.registerDefaultRules = function() {
    ...
    */
    ...
    this.registerRule(require('../rules/require-object-shorthand'));
    /* ES6 only (end) */
    ...
    this.registerRule(require('../rules/disallow-spaces-inside-function-calls'));
    this.registerRule(require('../rules/require-spaces-inside-function-calls'));
};
