...
program
    ...
    .option('-r, --reporter <reporter>', 'error reporter, console - default, text, checkstyle, junit')
 ...
 */
if (isConfigExist || program.preset) {
    var config = isConfigExist ? require(configPath) : {};
